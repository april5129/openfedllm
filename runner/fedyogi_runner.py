...
from algo.fedyogi.client import *
from algo.fedyogi.server import *
...
fed_args.fed_alg = "fedyogi" # Force the fed_alg parameter to be 'fedyogi'
...
print("Fedyogi federated training finished!")