...
from algo.FT.scaffold.client import *
from algo.FT.scaffold.server import *
...
def train_client(client_id, global_dict, local_datasets, round, fed_args, script_args, 
    ...
    try:
        ...
        # Creat trainer
        trainer = get_scaffold_local_trainer(
            model=model,
            tokenizer=tokenizer,
        ...
        auxiliary_model_list[client], auxiliary_delta_dict[client] = trainer.get_auxiliary_param() # scaffold
...
for round in tqdm(range(fed_args.num_rounds)):
    ...
    global_dict, global_auxiliary = global_aggregate(
        ...
        clients_this_round, auxiliary_info=(global_auxiliary, auxiliary_delta_dict)
    )
