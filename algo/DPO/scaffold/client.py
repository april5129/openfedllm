...
from FT.scaffold.client import SCAFFOLD_Callback

def get_fed_local_dpo_trainer(script_args, model, model_ref, tokenizer, training_args, local_dataset, global_dict, local_auxiliary, global_auxiliary):
